...
//        FeatureModel(R.drawable.tomtitrangme,"Tôm tít rang me","3"),
//        FeatureModel(R.drawable.hamburger,"hamburger","4"),
//        FeatureModel(R.drawable.fried_potatoes,"fried","5"),
//        FeatureModel(R.drawable.ice_cream,"ice_cream","6"),
//        FeatureModel(R.drawable.sandwich,"sandwich","7")
//    )

//    val newList = listOf<NewprModel>(
//        NewprModel(R.drawable.hamburger,"pizza","3"),
//        NewprModel(R.drawable.hamburger,"hamburger","4"),
//        NewprModel(R.drawable.fried_potatoes,"fried","5"),
//        NewprModel(R.drawable.ice_cream,"ice_cream","6"),
//        NewprModel(R.drawable.sandwich,"sandwich","7")
//    )
...
//                R.id.user -> replaceFragment(InfoUserFragment())
//                else ->{
//
//                }
//            }
...
//        }
    ...
    private fun homeFeature() {
        ...
        val url = "http://192.168.1.84/doan3/LOG/ShowFr.php"
        ...
        val request = JsonArrayRequest(
            ...
            { response ->
                for (i in 0 until response.length()) {
                    ...
                    val imageUrl =
                        "http://192.168.1.84/WEBTH/doan2/web/admin/uploads/" + item.getString("image")
    ...
    private fun homeNew(){
        ...
        val queue = Volley.newRequestQueue(this)
        val url = "http://192.168.1.84/doan3/LOG/ShowNew.php"
        val images = mutableListOf<ProductModel>()
...
//    fun onClickFeature(position: Int) {
//        when(position){
//            0 -> startActivity(Intent(this,DetailProduct::class.java))
//        }
//    }
//
//    fun onClickFavourite(position: Int) {
//        when(position){
//            0 -> startActivity(Intent(this,DetailProduct::class.java))
//        }
//    }
