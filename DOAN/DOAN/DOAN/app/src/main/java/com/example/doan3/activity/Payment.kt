...
class Payment : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "http://192.168.1.84/doan3/LOG/ShowProductCart.php?sId=$encodedSId"
...
// het
    ...
    private fun addToOrder(productId: Int, customer_id: Int, productName: String?, price: Int, quantity: Int, imageUrl: String?) {
        ...
        val request = okhttp3.Request.Builder()
            .url("http://192.168.1.84/doan3/LOG/insert_order.php")  // Thay YOUR_PHP_URL bằng URL của mã PHP để thêm dữ liệu vào MySQL
            .post(formBody)
            .build()
