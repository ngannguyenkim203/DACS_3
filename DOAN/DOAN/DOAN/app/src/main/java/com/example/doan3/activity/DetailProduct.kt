...
// Xử lý sự kiện nút "Trừ"
        ...
        binding.btnWishlist.setOnClickListener{
                if (binding.btnWishlist.isPressed) {
                    val drawable = ContextCompat.getDrawable(this@DetailProduct, R.drawable.baseline_favorite_24)
                    ...
                    val drawable = ContextCompat.getDrawable(this@DetailProduct, R.drawable.baseline_favorite_border_24)
                    binding.btnWishlist.setImageDrawable(drawable)
                }
            }
    ...
    private fun addToCart(productId: Int,sId: String?, productName: String?, price: String, quantity: Int, imageUrl: String?) {
        ...
        val request = Request.Builder()
            .url("http://192.168.1.84/doan3/LOG/add_to_cart.php")  // Thay YOUR_PHP_URL bằng URL của mã PHP để thêm dữ liệu vào MySQL
            .post(formBody)
            .build()
    ...
    private fun addWislist( productName: String?, imageUrl: String?, price: String,productId: Int, customer_id: Int) {
        ...
        val formBody = FormBody.Builder()
            ...
            .build()
        val request = Request.Builder()
            .url("http://192.168.1.84/doan3/LOG/Insert_wishlist.php")  // Thay YOUR_PHP_URL bằng URL của mã PHP để thêm dữ liệu vào MySQL
            .post(formBody)
            .build()
