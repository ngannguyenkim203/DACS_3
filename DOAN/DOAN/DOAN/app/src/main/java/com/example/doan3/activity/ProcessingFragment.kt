...
import com.example.doan3.databinding.FragmentProcessingBinding
...
class ProcessingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.OrDetProcessing.layoutManager = LinearLayoutManager(requireContext())
        adapter = ProcessingFragmentAdapter(images)
        binding.OrDetProcessing.adapter = adapter
        ...
        val url = "http://192.168.1.84/doan3/LOG/Orderdetails.php?customer_id=$customer_id" // Thay thế bằng URL của máy chủ MySQL của bạn
